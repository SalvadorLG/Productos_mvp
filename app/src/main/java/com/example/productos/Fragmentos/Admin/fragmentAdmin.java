...
public class fragmentAdmin extends Fragment {
    ...
    public void Datos_User(String token, int statusCode, TextView resultado){
        ...
        resultado.setText(token);
        //Temporal = token;
    }

    public void Actualizar_resultado(String token, int statusCode){
        System.out.println("primero");
        System.out.println("TOKEN ======> "+token);
        System.out.println("STATUS ======> "+statusCode);
        //Temporal = token;
    ...
    public void onAttach(Context context) {
        ...
        if (context instanceof FragmentAdminListener) {
            listener = (FragmentAdminListener) context;
        } else {
            throw new RuntimeException(context.toString()
                    + " must implement FragmentAdminListener");
        }
    }
